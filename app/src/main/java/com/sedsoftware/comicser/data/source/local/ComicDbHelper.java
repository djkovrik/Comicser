...
public class ComicDbHelper extends SQLiteOpenHelper {
  ...
  private static final String SQL_CREATE_TODAY_ISSUES_TABLE =
      "CREATE TABLE " + IssueEntry.TABLE_NAME_TODAY_ISSUES + " (" +
          ...
          IssueEntry.COLUMN_ISSUE_SMALL_URL + TEXT_TYPE + SEPARATOR +
          IssueEntry.COLUMN_ISSUE_MEDIUM_URL + TEXT_TYPE + SEPARATOR +
          IssueEntry.COLUMN_ISSUE_SUPER_URL + TEXT_TYPE + SEPARATOR +
